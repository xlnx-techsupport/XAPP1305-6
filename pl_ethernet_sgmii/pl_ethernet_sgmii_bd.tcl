...
set design_name pl_ethernet_sgmii 
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_eth_0_sgmii [get_bd_intf_ports sgmii_0] [get_bd_intf_pins axi_eth_0/sgmii]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_eth_0/signal_detect] [get_bd_pins tie_high/dout]
