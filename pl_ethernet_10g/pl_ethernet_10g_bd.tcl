...
proc create_root_design { parentCell } {
  ...
  set rx_data_fifo_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 rx_data_fifo_0 ]
  set_property -dict [ list \
  ...
  set tx_data_fifo_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 tx_data_fifo_1 ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {32768} \
   CONFIG.FIFO_MODE {2} \
   CONFIG.HAS_TLAST {1} \
...
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_dma_0_s2mm_prmry_reset_out_n]
