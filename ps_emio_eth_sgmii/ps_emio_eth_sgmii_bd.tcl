...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_2 "PS-EMIO SGMII ETHERNET" [get_bd_designs $design_name]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net gig_ethernet_pcs_pma_0_sgmii [get_bd_intf_ports sgmii_0] [get_bd_intf_pins gig_ethernet_pcs_pma_0/sgmii]
